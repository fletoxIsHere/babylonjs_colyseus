...
export default class Menu {
    ...
    private async createGame(method: string): Promise<void> {
        // let musicApplying: musicApplying;
        // try {
        //     switch (method) {
        //         case "create":
        //             this.swapLoadingMessageBox(true);
        //             this.musicApplying = new MusicApplying(this._canvas, this._engine, await this._colyseus.create(ROOM_NAME));
        //             break;
        //         case "join":
        //             this.swapLoadingMessageBox(true);
        //             this.musicApplying = new MusicApplying(this._canvas, this._engine, await this._colyseus.join(ROOM_NAME));
        //             break;
        //         default:
        //             this.swapLoadingMessageBox(true);
        //             this.musicApplying = new MusicApplying(this._canvas, this._engine, await this._colyseus.joinOrCreate(ROOM_NAME));
        //     }
        //     this._scene.dispose();
